...
const StatCard = ({ value, label }: Stat) => (
  <Card className="shadow-none bg-muted/50 border-border text-center rounded-xl">
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-grow">
            <p className="font-medium text-lg text-foreground">{testimonial.name}</p>
        ...
        <div className="flex items-center gap-2 my-4">
          <span className="font-medium text-base text-foreground">{testimonial.rating.toFixed(1)}</span>
          <div className="flex">
...
export const ClientsSection = ({
  ...
  return (
    <section className={cn("w-full bg-background text-foreground font-sans py-20 md:py-28", className)}>
      <div className="container mx-auto grid grid-cols-1 px-4 md:px-6 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div className="flex flex-col gap-6 lg:sticky lg:top-20">
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tight">{title}</h2>
