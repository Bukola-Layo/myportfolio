...
export function CTASection() {
  return (
    <section className="bg-[#101010] py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <p className="mb-4 text-sm font-medium uppercase tracking-widest text-[#FAFAFA]/50">
          Ok, you&apos;ve scrolled this far
        </p>
        <h2 className="text-4xl font-medium leading-tight tracking-tight text-[#FAFAFA] md:text-5xl">
          You must be looking to do something now right?
        </h2>

        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="mailto:layodesign001@gmail.com"
            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#FAFAFA] px-8 text-sm font-medium text-[#101010] transition-colors hover:bg-[#FAFAFA]/90 sm:w-auto"
          >
            <Mail className="h-4 w-4" />
            Email me
          </Link>
          <a
            href="/public/resume/Bukola%20Akintomide%202026%20CV%20with%20socials.pdf"
            download
            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-full border border-[#FAFAFA]/20 px-8 text-sm font-medium text-[#FAFAFA] transition-colors hover:bg-[#FAFAFA]/10 sm:w-auto"
          >
